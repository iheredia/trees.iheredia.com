$ ->
  ...
  gui = new dat.GUI(
    load: {
      ...
      "closed": false,
      "remembered": {
        "tree": {"0":{"growing_time":200,"background":"#ffffff","clean_canvas":true,"shape":"rects"},"1":{"up_growing":150,"down_growing":20,"depth":7,"color":{"h":40,"s":0.9,"v":0.3},"hue_variance":5,"saturation_variance":30,"value_variance":10},"2":{"depth":5,"squareness":50,"color":{"h":115,"s":0.9,"v":0.3},"hue_variance":10,"saturation_variance":10,"value_variance":10},"3":{"width":48.32,"height":62.816},"4":{"split_direction":90,"split_variance":0.5}},
